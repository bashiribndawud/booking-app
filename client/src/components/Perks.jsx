...
const Perks = ({selected, onChange}) => {
    function handleSelectedPerks(evt) {
  ...
  return (
    <>
      {" "}
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 place-content-between gap-2">
        <label
          htmlFor=""
        ...
        >
          ...
          <span className="text-gray-500 leading-3">Free parking spot</span>
        </label>
        <label
          htmlFor=""
        ...
        >
          ...
          <span className="text-gray-500">Private Entrance</span>
        </label>
      </div>
    </>
  );
